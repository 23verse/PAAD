...
- `repair-deficient` (derived from the repair-deficient group with low CNV score)
...
**Our identified subtypes were informative in prognosis (as shown in the figure): the best prognosis for repair-deficient patients, and the worse for repair-proficient and proliferation-active patients.**
