...
- We are the first to report that the poor prognosis is associated with amplification of genes involved in DNA repair and receptor tyrosine kinase (RTK) related signaling pathways.
...
```{r pathway, fig.cap="", fig.width=7.5, fig.height=3, echo=FALSE, eval=T, fig.align="center",out.width="100%"}
library(png)
library(grid)
